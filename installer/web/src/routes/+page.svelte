...
<div class="bg-white">
    ...
    <div class="m-4 xl:mx-8 flex flex-col gap-4">
        ...
        <span>qmdl_store_path [string]</span>
        <span>port [string]</span>
        <span>debug_mode [bool]</span>
        <span>enable_dummy_analyzer [bool]</span>
        <span>colorblind_mode [bool]</span>
