...
use crate::server::{
    ServerState, debug_set_display_state, get_config, get_qmdl, get_severity_indicator_images,
    get_time, get_zip, reset_severity_indicator_image, serve_static, set_config,
    set_time_offset, test_notification, upload_severity_indicator_image,
};
...
fn get_router() -> AppRouter {
    Router::new()
        ...
        .route("/api/severity-indicator-images", get(get_severity_indicator_images))
        .route("/api/severity-indicator-images/{slot}", post(upload_severity_indicator_image))
        .route("/api/severity-indicator-images/{slot}/reset", post(reset_severity_indicator_image))
