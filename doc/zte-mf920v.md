...
The installer requires a USB connection to the device. It logs in via the web interface, enables ADB over USB, then installs rayhunter over ADB.
...
You can obtain a root ADB shell with the following command:
